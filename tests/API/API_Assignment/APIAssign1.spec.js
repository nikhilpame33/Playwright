...
const userEmail = "KYadav1@gmail.com"
const userPass = "KYadav@1"
...
test('sandbox banner is shown 6 events', async ({ page }) => {
...
test('sandbox banner is shown 4 events', async ({ page }) => {
    page.route("**/api/events**", async route => {
        await route.fulfill({
            status: 200,
            contentType: 'application/json',
